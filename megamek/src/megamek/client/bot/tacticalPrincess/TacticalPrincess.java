...
public class TacticalPrincess extends Princess {
     ...
     */
    public static TacticalPrincess createPrincess(String name, String host, int port, BehaviorSettings behavior) {
        TacticalPrincess result = new TacticalPrincess(name, host, port);
     ...
     */
    public TacticalPrincess(final String name, final String host, final int port) {
